...
public class Controller implements Initializable{
  private ObservableList <Evenement> list ;
    ...
    public void ajouter(ActionEvent event) throws IOException {
        try {
            URL url = Paths.get("./Fxml/h15.fxml").toUri().toURL();
            FXMLLoader loader = new FXMLLoader(url);
    ...
    public void load(){
        try {
            ...
            ResultSet rs=conn.createStatement().executeQuery("SELECT * FROM `evenement`  WHERE 1");
        ...
        activitéCol.setCellValueFactory(new PropertyValueFactory<Evenement,String>("activité"));
