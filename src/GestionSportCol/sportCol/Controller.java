package GestionSportCol.sportCol;
...
public class Controller {
    ...
    public void listeEtud(ActionEvent event) throws IOException {
        try {
            URL url = Paths.get("./Fxml/h3.fxml").toUri().toURL();
            FXMLLoader loader = new FXMLLoader(url);
    ...
    @FXML
    public void listeEntraineur(ActionEvent event) throws IOException {
        try {
            URL url = Paths.get("./Fxml/h9_2.fxml").toUri().toURL();
            FXMLLoader loader = new FXMLLoader(url);
            Stage stage = (Stage) listeEntraineur.getScene().getWindow();
            Scene scene = new Scene(loader.load());
            stage.setScene(scene);
        }catch (IOException io){
            io.printStackTrace();
    ...
    @FXML
    public void listeEquipe(ActionEvent event) throws IOException {
        try {
            URL url = Paths.get("./Fxml/h8.fxml").toUri().toURL();
            FXMLLoader loader = new FXMLLoader(url);
            Stage stage = (Stage) listeEquipe.getScene().getWindow();
            Scene scene = new Scene(loader.load());
            stage.setScene(scene);
        }catch (IOException io){
            io.printStackTrace();
