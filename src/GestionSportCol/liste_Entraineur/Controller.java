package GestionSportCol.liste_Entraineur;
  ...
  private ObservableList <Entraineur> list ;
    ...
    public void load(){
        try {
            ...
            ResultSet rs=conn.createStatement().executeQuery("SELECT * FROM `entraineur`  WHERE `entraineur`.`équipe_sport_collectif_idsport_collectif` = '"+id+"'");
